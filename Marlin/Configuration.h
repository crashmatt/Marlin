...
const bool U_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop.
const bool V_MIN_ENDSTOP_INVERTING = false; // set to true to invert the logic of the endstop.
const bool U_MAX_ENDSTOP_INVERTING = false; // set to true to invert the logic of the endstop.
const bool V_MAX_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop.
...
#define HOMING_FEEDRATE {50*60, 50*60, 50*60, 50*60}  // set the homing speeds (mm/min)
...
//#define DEACTIVATE_SERVOS_AFTER_MOVE
  ...
  #define SERVO_DEACTIVATION_DELAY 1000
#endif
